 ...
 * 1、安装redis：使用docker：docker run --name picker-redis -p 6379:6379 -d redis --requirepass "password"
 * 2、引入redis的starter
 * 3、配置redis
 * 4、测试缓存
 * 		原理：CacheManage===Cache 缓存组件来实际给缓存中存取数据
 ...
 *
 */
@MapperScan("com.zhao.cache.mapper")
